...
소상공인은 전문 마케팅 인력과 예산이 부족해 시장 분석부터 콘텐츠 제작까지 전 과정을 혼자 감당해야 하는 구조적 어려움을 겪습니다.   
이 문제를 해결하기 위해 Top-Level Supervisor가 사용자 요청을 분석하여 시장 분석 자동화, 상황별 맞춤 전술 즉각 제안, 채널별 콘텐츠 초안 생성의 세 가지 워크플로우로 라우팅하는 멀티 에이전트 마케팅 전략 시스템을 개발했습니다.
</br>

1. 시장 분석 자동화, 2. 상황별 맞춤 전술 즉각 제안, 3. 채널별 콘텐츠 초안 생성
...
* **Input:** [ : 가맹점 ID, 업종]
* **Process:** [ : Analysis Team과 Strategy Team이 협력하여 STP 분석 및 4P 전략 도출]
* **Output ( 시):** [AI가 생성한 실제 '종합 컨설팅 보고서'  시를 마크다운이나 이미지로 첨부]
...
* **Input:** [ : 가맹점 ID, 기간, 특정 상황( : 비 오는 날)]
* **Process:** [ : Situation Agent가 날씨/이벤트 정보를 분석하여 즉각적인 전술 제안]
* **Output ( 시):** [AI가 생성한 '전술 카드'  시]

> **[AI 생성 전술 카드  시]**
>
> * **상황:** 주말 비  보 (11/08 ~ 11/09)
> * **제안:** "비 오는 날의 따뜻함" 프로모션
...
* **Input:** [ : 가맹점 ID, 타겟 채널( : 인스타그램)]
* **Process:** [ : Content Agent가 전략을 바탕으로 채널 맞춤형 가이드라인 작성]
* **Output ( 시):** [AI가 생성한 '콘텐츠 가이드'  시]

> **[AI 생성 콘텐츠 가이드 (인스타그램)]**
>
> * **카피  시:** "비가 내려도 낭만은 포기 못해! ☔ 테일러 카페에서 따뜻한 라떼 한 잔 어때요?"
